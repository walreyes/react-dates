...
var propTypes = (0, _airbnbPropTypes.forbidExtraProps)({
  ...
  isYearsEnabled: _propTypes2['default'].bool,
  ...
  _createClass(DayPicker, [{
    ...
    value: function () {
      function updateStateAfterMonthTransition() {
        var _props2 = this.props,
            ...
            onYearChange = _props2.onYearChange;
    ...
    value: function () {
      function renderWeekHeader(index) {
        ...
        var header = [];
        for (var i = 0; i < 7; i += 1) {
          header.push(_react2['default'].createElement('li', { key: i, style: { width: daySize } }, _react2['default'].createElement('small', null, (0, _moment2['default'])().day((i + firstDayOfWeek) % 7).format('dd'))));
        }
    ...
    value: function () {
      function render() {
        ...
        var _props5 = this.props,
            ...
            isYearsEnabled = _props5.isYearsEnabled,
        ...
        return _react2['default'].createElement('div', {
          ...
          role: 'region',
          tabIndex: -1
        }, !verticalScrollable && !isYearsEnabled && this.renderNavigation(), _react2['default'].createElement('div', {
          ...
          focusedDate: focusedDate,
          phrases: phrases
        }), verticalScrollable && !isYearsEnabled && this.renderNavigation()), !isTouch && !hideKeyboardShortcutsPanel && _react2['default'].createElement(_DayPickerKeyboardShortcuts2['default'], {
