...
var _CalendarMonth = __webpack_require__(53);

var _CalendarMonth2 = _interopRequireDefault(_CalendarMonth);

var _isTransitionEndSupported = __webpack_require__(51);
...
var _isPrevMonth = __webpack_require__(50);

var _isPrevMonth2 = _interopRequireDefault(_isPrevMonth);

var _isNextMonth = __webpack_require__(49);
...
var CalendarMonthGrid = function (_React$Component) {
  ...
  function CalendarMonthGrid(props) {
    ...
    _this.selectMonth = _this.selectMonth.bind(_this);
  ...
  _createClass(CalendarMonthGrid, [{
    ...
    key: 'selectMonth',
    value: function () {
      function selectMonth(currentMonth, newMonthVal) {
    ...
    key: 'selectYear',
    value: function () {
      function selectYear(currentMonth, newYearVal) {
        var newMonth = currentMonth.clone();
        var orientation = this.props.orientation;
        var months = this.state.months;
    ...
    value: function () {
      function render() {
        ...
        var _props2 = this.props,
            ...
            isYearsEnabled = _props2.isYearsEnabled,
        ...
        return _react2['default'].createElement('div', {
          ...
          return _react2['default'].createElement(_CalendarMonth2['default'], {
            ...
            onSelectMonth: _this2.selectMonth,
            onSelectYear: _this2.selectYear,
